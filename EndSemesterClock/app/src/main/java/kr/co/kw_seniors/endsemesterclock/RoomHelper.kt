...
@Database(entities = arrayOf(NoticeItem::class, ProfessorItem::class), version=1, exportSchema=false)
abstract class RoomHelper: RoomDatabase() {
    ...
    // RoomHelper 인스턴스는 professorItemDAO() 메서드를 호출함으로써 ProfessorItemDAO 인터페이스 내에 선언된 DML 쿼리 메서드 사용 가능
    abstract fun professorItemDAO(): ProfessorItemDAO
}